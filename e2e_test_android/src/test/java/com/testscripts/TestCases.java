...
public class TestCases extends RootTest {
    ...
    public void loginWithInvalidUsername() {
    	...
    	brow.reset();
    	login.loginToApp("invalidUser", "Password1##");
    ...
    public void loginWithInvalidPassword() {
    	...
    	brow.reset();
    	login.loginToApp("invalidPassword", "Password1###");
    	login.invalidPasswordExpected();
    	brow.screenShot();
    	System.out.println("Testcase 04 - Successfully Completed");
    }
    
    // Test case_05 verify 3rd message (Retry 3 times login with Invalid Password) -- S //can't verify 2nd message with mock data 
    @Test
    public void passwordRetry() throws Exception {
    	System.out.println("Running Testcase 05 - verify 3rd message");
    	brow.reset();
    	login.loginToApp("accountLocked", "Password1###");
    	login.retryPassword();
    	brow.screenShot();
...
//      	viewaccounts.transferButtonOnAccountDetailsPage("CHEQUING");
	...
	// test case_53 Credit Card details on CreditCardDetails Page --A 10-5-2018
	@Test
	public void creditCarddetails() {
		System.out.println("Running Testcase 53 - Verify Credit Card details on Card details page");
		brow.reset();
		login.loginToApp("darkelor", "Password1##");
		login.acceptTermAndConditions();
		viewaccounts.viewCardAccount();
		System.out.println("Testcase 53 - Credit card details test Successfully Completed");
	}
	
	// test case_54 Add Payee functionality check --A 08-06-2018
    @Test
    public void billPaymentaddPayee() {
      System.out.println("Running Testcase  - Verify add Payee funtionality from app ");
      brow.reset();
      login.loginToApp("darkelor", "Password1##");
      login.acceptTermAndConditions();
      billpayment.PayeePagenav();
      billpayment.addPayee();
      System.out.println("Testcase 54 - Add Payee test Successfully Completed");
    }
    
    // test case_55 Adding payee cancel modal test --A 10-5-2018
    @Test
    public void billPaymentaddPayeeCancel() {
      System.out.println("Running Testcase  - Verify cancel modal add Payee funtionality from app ");
      brow.reset();
      login.loginToApp("darkelor", "Password1##");
      login.acceptTermAndConditions();
      billpayment.PayeePagenav();
      billpayment.addPayeeCancel();
      System.out.println("Testcase 55 - Adding payee cancel modal test Successfully Completed");
    }
    
    // Test case 56 Error Handling add payee -A 13-06-2018
    @Test
    public void ErrHandlingbillPaymentaddPayee() {
        System.out.println("Running Testcase 56 - Verify Error Handling add Payee funtionality from app ");
        brow.reset();
        login.loginToApp("stanigar", "Password1##");
        login.acceptTermAndConditions();
        billpayment.PayeePagenav();
        billpayment.ErrHandlingaddPayee();
        System.out.println("Testcase 56 - Adding payee Error Handling test Successfully Completed");
    }

    // Test case 57 for Payment through Credit Cards --A
    @Test
    public void payBillsCreditCard() {
        System.out.println("Running Testcase 57 - Verify Payment from Credit Cards");
        brow.reset();
        login.loginToApp("stanigar", "Password1##");
        login.acceptTermAndConditions();
        billpayment.payBillsCreditCard();
        System.out.println("Testcase 57 - Verify Payment from Credit Cards test Successfully Completed");
    }
    
    // Test case 58 for Credit Cards Payment Cancel modal  payBillsCreditCardCancelModal --A
    @Test
    public void payBillsCreditCardCancelModal() {
        System.out.println("Running Testcase 58 - Cancel Modal Payment from Credit Cards navigation ");
        brow.reset();
        login.loginToApp("darkelor", "Password1##");
        login.acceptTermAndConditions();
        billpayment.payBillsCreditCardCancelModal();
        billpayment.payBillsCreditCardCancelModalreviewPage();
        System.out.println("Testcase 58 - Credit Cards pay Cancel modal test Successfully Completed");
    }
  
    // Test case 59 Validating error message for Restricted Payee(For darkelor 'ADINCBCRUNION') from Credit Cards--A
    @Test
    public void creditCardRestrictedPayee() {
        System.out.println("Running Testcase 59 - Restricted Payee Message Treatment from Credit Cards");
        brow.reset();
        login.loginToApp("darkelor", "Password1##");
        login.acceptTermAndConditions();
